...
<div class="row">
  ...
  <br><br>
  <h4> <span class="span label label-primary">Total de horas realizadas: <%=cidada%> </span></h3>
  <br>
  <h4> <span class="span label label-info">Total de horas à cumprir:  <%=cidadaDiferenca%> </span></h3>
  </div>
