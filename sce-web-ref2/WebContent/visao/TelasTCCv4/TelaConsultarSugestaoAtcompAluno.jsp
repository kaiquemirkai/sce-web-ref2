...
<form class= "form-horizontal" role = "form" name="frmConsultarSugestaoAluno" action="/sce-web-ref2/ServletControle" method="post">   
    	
		<input type="hidden" name="acao" value="consultarSugestaoAluno">
