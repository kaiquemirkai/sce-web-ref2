...
<form class= "form-horizontal" role = "form" name="frmAlterarSugestaoAluno" action="/sce-web-ref2/ServletControle" method="post">   
    	
		<input type="hidden" name="acao" value="alterarSugestaoAluno">
	 ...
	 <div class="form-group">
        ...
        <div class="col-sm-10">
             <textarea name="txtDescricaoAtividade" rows="4" cols="4" class="form-control" style="width: 25em" placeholder="Descreva sua sugestão aqui" value=""></textarea>
        </div>
        </div>
