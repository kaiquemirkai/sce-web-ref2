...
<form class= "form-horizontal" role = "form" name="frmCadastrarSugestaoAluno" id="frmCadastrarSugestaoAluno" action="/sce-web-ref2/ServletControle" method="post">   
    	
		<input type="hidden" name="acao" value="cadastrarSugestaoAluno">
