...
<script type="text/javascript" language="javascript">
	...
	function consultar() {
		document.formEmpresaExcluir.acao.value = "MostraFormConsultarEmpresaConfirmaExclusao";
...
<title>Controle de Empresas - excluir</title>
</head>
<body>
<jsp:include page="Cabecalho.jsp" />
	<div id="principal">
		<div id="titulo">
			<h3>Controle de Empresas - excluir</h3>
		</div>
		<hr>
		<div id="formulario3">
			<form name="formEmpresaExcluir" action="/sce-web-ref2/ServletControle" method="post">
				<table id="tabcampos">
					<tr>
						...
						<td><input id="campo" size="40" type="text" name="txtNomeDaEmpresa"
							value=""></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input id="botao" type=button name=btnExcluir onclick=consultar() value=Excluir>
